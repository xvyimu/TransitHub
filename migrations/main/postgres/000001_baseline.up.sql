-- PostgreSQL baseline: empty-DB schema matching GORM AutoMigrate output.
-- Generated from the SQLite baseline by dialect translation.
-- Type mapping: id (autoincrement PK) -> bigserial; SQLite numeric (bool) -> boolean;
--   real -> double precision; json -> jsonb; datetime -> timestamptz;
--   decimal(p,s) -> numeric(p,s). Identifiers are double-quoted (reserved words
--   like "group", "key", "user").
-- Postgres index names are schema-global (unlike MySQL per-table); all names here
...
CREATE TABLE "models" (
  ...
  "endpoints" text,
  "status" integer DEFAULT 1,
  "sync_official" integer DEFAULT 1,
  "created_time" bigint,
  "updated_time" bigint,
  "deleted_at" timestamptz,
  "name_rule" integer DEFAULT 0
);
...
CREATE TABLE "subscription_plans" (
  ...
  "price_amount" numeric(10,6) NOT NULL,
  ...
  "allow_balance_pay" boolean DEFAULT true,
